...
| 3 | Do., **1. Okt. 2026**, 08:15–10:00 Uhr | Stabilität · Keystone · Kipppunkt |
...
**Bewertung:** bestanden / nicht bestanden über **Mitarbeit** (Kurzpräsentationen an den Checkpoints). **Anwesenheitspflicht** an den Checkpoint-Terminen; **mindestens 3 von 4** müssen gemacht werden. Details: **[Kursinfo (PDF)](kursinfo.pdf)** (auch auf ILIAS).  
...
### Woche 3 — Stabilität: ein Endpunkt, zwei Endpunkte, Keystone / Kipppunkt
...
- **Sitzung:** ~45 min Vorlesung + ~45 min Notebook (Spielraum)
- **Arc:** Begriffe → **ein** Endpunkt (Ausschluss) → **zwei** Endpunkte (Bistabilität) → Keystone (*Pisaster*) → Kipppunkt / Hysterese (Seeotter)
- **Brücke Woche 2:** Persistenz auf der beobachteten Zeitskala ≠ stabiles Gleichgewicht
- Arbeitsbegriffe: **Gleichgewicht**, Rückkehr nach kleiner Störung, **Einzugsgebiet**
- **Konkurrenzausschluss:** Gause-*Paramecium* + LV; für positive Starts derselbe stabile Endpunkt
- **Bistabilität:** dieselben Gleichungen, andere $\alpha$; zwei Einzugsgebiete; Grasland/Wald als Analogie
- **Keystone (Vorlesung):** Paine 1966 + Toy-Modell (Raumkonkurrenz + Präferenzfrass); Seestern hält Zustand «offen»
- **Notebook:** Yellowstone-Food-Web (Aspen–Sage–Elch–Wolf) — dieselbe Idee rechnen
- **Otter / Kipppunkt:** Smith 2021 (Gonadenindex, halten ≠ wiederherstellen); Langendorf 2025 (geschätzte, zustandsabhängige Interaktionsstärken; WVI vs. SNI)
