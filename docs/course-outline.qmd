...
| **Evolution (deterministisch)** | 5–8 | Vererbung, Selektion, Raum (Farbmorphen → Stichling) | Rekursionsgleichungen; Datentabellen, `sapply()`, Filtern | **B · Woche 8** |
...
| **B** | Woche **8** · **5. Nov. 2026** | Evolution (deterministisch) | Eine Frage zu häufigkeitsabhängiger Fitness, Überdominanz oder Stichling und $F_{ST}$ | Gleiches Format; Schwerpunkt auf Rekursion / Gleichgewichten |
...
**Präsenz:** An Checkpoint-Terminen (**Wochen 4, 8, 11, 14**) müssen Studierende **anwesend sein** und in der Gruppe den Fortschritt zeigen. Modul 1: [Überblick Wochen 1–4](module-01-overview.qmd). Modul 2: [Überblick Wochen 5–8](module-02-overview.qmd). Modul 3: [Überblick Wochen 9–11](module-03-overview.qmd). [Glossar](glossary.qmd).
...
- **Notebook:** Yellowstone-Food-Web (Aspen–Sage–Elch–Wolf) — Wolf ein- und ausschalten
### Woche 4 — Spieltheorie, RPS & **Checkpoint A**
**Wann:** Do., 8. Okt. 2026, 08:15–10:00 Uhr  
**Materialien:** [Folien](../weeks/week-04/slides.qmd) · [PDF](../weeks/week-04/slides.pdf) · Notebook in der Sitzung (nicht vorab)
...
**[Modul 2](module-02-overview.qmd)** — Vererbung, Selektion, Raum.
...
- Rückblick auf den Werkzeugkasten der Wochen 2–8; Brücke: eine neue Mutation beginnt mit einer Kopie — Zufall ab Woche 9
