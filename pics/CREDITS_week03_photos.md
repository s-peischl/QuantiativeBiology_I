# Photo credits (Woche 3)

Teaching copies from Wikimedia Commons. Always verify author and license on the Commons file page before redistribution beyond the course.

| Local file | Commons title | Use |
|------------|---------------|-----|
| `yellowstone/wolf_yellowstone.jpg` | Canis lupus laying in grass.jpg | Top predator |
