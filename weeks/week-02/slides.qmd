...
**Hier:** nur so viel, dass Sie danach im Notebook spielen können:
...
**A** eine Art — `next_N`, $r$ und Start $\lessgtr K$ **selbst ändern**  

**B** zwei Arten — `next_state`, Parameter selbst ändern  
