...
## Empirische Daten im Phasenraum
...
#| fig-width: 7
#| out-width: 62%
plot(both$paramecium, both$didinium, type = "o", pch = 16, lwd = 1.8,
     xlab = "Beute: Paramecium", ylab = "Raeuber: Didinium",
     main = "Ein Punkt = ein Tag")
arrows(both$paramecium[-nrow(both)], both$didinium[-nrow(both)],
       both$paramecium[-1], both$didinium[-1],
       length = 0.08, angle = 22, col = "#5d6d7e")
imm <- both$immigration == "y"
points(both$paramecium[imm], both$didinium[imm],
       pch = 21, bg = "#f4d03f", cex = 1.4)
legend("topright", "Immigration", pch = 21, pt.bg = "#f4d03f", bty = "n")
```

**Pfeile = Zeit:** Erst nimmt die Beute zu, dann folgt der Räuber.

Die markierten Tage enthalten Immigration — die Kurve ist daher keine ungestörte geschlossene Bahn.
